...
class OSCServer:
    ...
    def _handle_message(self, data, addr):
        ...
        try:
            ...
            if message.address in self.handlers:
                ...
                GLib.idle_add(self._show_toast, f"Unknown OSC address: {message.address}")
    ...
    def handle_set_speed(self, args, addr):
        ...
        try:
            ...
            if 10 <= speed <= 500:  # Reasonable limits
                ...
                self._send_response(addr, '/teleprompter/error', 'Speed must be between 10-500 WPM')
        except ValueError:
    ...
    def handle_set_fontsize(self, args, addr):
        ...
        try:
            ...
            if 10 <= size <= 200:  # Reasonable limits
                ...
                self._send_response(addr, '/teleprompter/error', 'Font size must be between 10-200')
        except ValueError:
    ...
    def handle_set_position(self, args, addr):
        ...
        try:
            ...
            if 0.0 <= position <= 1.0:
                ...
                self._send_response(addr, '/teleprompter/error', 'Position must be between 0.0-1.0')
        except ValueError:
    ...
    def handle_fullscreen(self, args, addr):
        ...
        self._send_response(addr, '/teleprompter/fullscreen', self.window.is_fullscreen())
    ...
    def handle_hmirror(self, args, addr):
        ...
        self._send_response(addr, '/teleprompter/hmirror', self.window.scroll_text_view.hmirror)
    ...
    def handle_vmirror(self, args, addr):
        ...
        self._send_response(addr, '/teleprompter/vmirror', self.window.scroll_text_view.vmirror)
    ...
    def handle_get_status(self, args, addr):
        ...
        self._send_response(addr, '/teleprompter/status/speed', self.window.settings.speed)
        self._send_response(addr, '/teleprompter/status/position', position)
        self._send_response(addr, '/teleprompter/status/fullscreen', self.window.is_fullscreen())
        self._send_response(addr, '/teleprompter/status/hmirror', self.window.scroll_text_view.hmirror)
        self._send_response(addr, '/teleprompter/status/vmirror', self.window.scroll_text_view.vmirror)